                ...
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="mb-4">
                                <h3>Registration</h3>
                                <p class="mb-4">System Infromasi Pertanian Bangka Belitung</p>
                            </div>
                            ...
                            <form action="<?= base_url('auth/registration'); ?>" method="post">
                                ...
                                <span class="d-block text-center my-4 text-muted">&mdash; Copyrigth &copy; <?php echo date('Y'); ?> &mdash;</span>
